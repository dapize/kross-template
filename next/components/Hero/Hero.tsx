...
export const Hero = () => {
  ...
  const onMouseMoveSection = useCallback(
    (e: MouseEvent) => {
  ...
  useEffect(() => {
    if ( !window.matchMedia("(pointer: coarse)").matches && !init.current ) {
      setTimeout(() => {
        const getPositions = {
  ...
  return (
    ...
    >
      ...
      <div className="layer-bg w-100">
        <Image src="/assets/images/illustrations/leaf-bg.png" className="img-fluid w-100" alt="bg-shape" width={1600} height={864} layout="raw"/>
      </div>
      <div className="layer" id="l2" ref={l2}>
        <Image src="/assets/images/illustrations/dots-cyan.png" alt="bg-shape" width={165} height={9} layout="raw"/>
      </div>
      <div className="layer" id="l3" ref={l3}>
        <Image src="/assets/images/illustrations/leaf-orange.png" alt="bg-shape" width={72} height={93} layout="raw"/>
      </div>
      <div className="layer" id="l4" ref={l4}>
        <Image src="/assets/images/illustrations/dots-orange.png" alt="bg-shape" width={125} height={9} layout="raw"/>
      </div>
      <div className="layer" id="l5" ref={l5}>
        <Image src="/assets/images/illustrations/leaf-yellow.png" alt="bg-shape" width={346} height={285} layout="raw"/>
      </div>
      <div className="layer" id="l6" ref={l6}>
        <Image src="/assets/images/illustrations/leaf-cyan.png" alt="bg-shape" width={169} height={96} layout="raw"/>
      </div>
      <div className="layer" id="l7" ref={l7}>
        <Image src="/assets/images/illustrations/dots-group-orange.png" alt="bg-shape" width={74} height={54} layout="raw"/>
      </div>
      <div className="layer" id="l8" ref={l8}>
        <Image src="/assets/images/illustrations/leaf-pink-round.png" alt="bg-shape" width={84} height={68} layout="raw"/>
      </div>
      <div className="layer" id="l9" ref={l9}>
        <Image src="/assets/images/illustrations/leaf-cyan-2.png" alt="bg-shape" width={161} height={120} layout="raw"/>
      </div>
